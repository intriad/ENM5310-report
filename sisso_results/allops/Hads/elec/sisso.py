...
model_path_test = model_path.split('train_dim')[0]

df_test.to_csv(f'{model_path_test}test_data.csv')

df_train = pd.DataFrame()
df_train['True'] = y_train_meas
df_train['Predicted'] = y_train_fit

model_path_train = model_path.split('train_dim')[0]

df_train.to_csv(f'{model_path_train}train_data.csv')
